...
"! Abstrakte Klasse fur die Klassen <strong>lcl_passenger_flight</strong> und <strong>lcl_cargo_flight</strong><br/>
...
"!  flight carrier
"! eine factory logik stellt sicher, dass nur eine instanz pro carrid ersellet werden
CLASS lcl_carrier DEFINITION CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    "! factory methode gibt eine instanz der klasse zuruck
    "! @parameter i_carrier_id | Dreistellige identifikation des Carrid
    "! @parameter r_result |  referez aif die Instanz
    "! @raising zcx_10_failed |  Ausnahmetext bei fehlgeschlaggener Instanziierung
    ...
    "! Suche nach einem <strong>Passagierflug</strong> zwischen 2 Flughafen
    "!<ul>
    "! <li>Der Flug liegt am oder nach dem Datum</li>
    "! <li>Hat eine Mindestzahl verfugbarer Platze frei</li>
    "! </ul>
    "! <ol>
    "! <li>Sorttext 1</li>
    "! <li>Sorttext 2</li>
    ...
    "! @parameter i_from_date | Erstes mogliches Flugdatum
    "! @parameter i_seats | Mindestzahl der verfugbaren Platze
